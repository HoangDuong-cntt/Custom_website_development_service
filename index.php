        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-8">
                    ...
                    <p class="lead text-white-50 mb-4">Chúng tôi biến ý tưởng của bạn thành trải nghiệm số nhanh, đẹp và mang lại khách hàng.</p><a data-magnetic data-ripple href="#dang-ky" class="btn btn-primary btn-lg me-2">Nhận Báo Giá <i class="bi bi-arrow-right"></i></a><a data-magnetic data-ripple href="#mau-web" class="btn btn-outline-light btn-lg">Xem Mẫu Web</a>
                </div>
                <div class="col-lg-4">
    ...
    <section id="mau-web" class="section horizontal-showcase" data-horizontal-scroll>
        <div class="container">
            ...
            <div class="row g-4 horizontal-track"><?php foreach ($templates as $t): ?><div class="col-md-6 col-lg-4 template-item" data-category="<?= e($t['category_slug']) ?>">
                        <div class="card border-0 shadow-sm template-card overflow-hidden" data-reveal="zoom-in" data-tilt><img class="template-img card-img-top" data-parallax-image src="<?= e($t['thumbnail']) ?>" alt="<?= e($t['title']) ?>">
    ...
    <section id="bang-gia" class="section bg-light pricing-showcase" data-price-section>
        <div class="container">
            ...
            <div class="row g-4 justify-content-center price-grid"><?php foreach ($plans as $p): ?><div class="col-md-6 col-lg-3" data-price-card>
                        <div class="card h-100 shadow-sm price-card <?= $p['is_popular'] ? 'popular' : '' ?>" data-parallax-card data-tilt>
        ...
        <div class="container">
            ...
            <div class="row g-3 mode-cards">
                <?php foreach ([['Buy', 'Thu hút đúng khách hàng ngay từ điểm chạm đầu tiên.', 'bi-bag-check', 'mau-web'], ['Sell', 'Biến sự quan tâm thành cuộc trò chuyện và đơn hàng.', 'bi-lightning-charge', 'dang-ky'], ['Rent', 'Tạo tài sản số bền vững để doanh nghiệp tăng trưởng dài hạn.', 'bi-building-up', 'quy-trinh']] as $mode): ?>
                    <div class="col-md-4"><a class="mode-card" data-mode-card data-tilt href="#<?= $mode[3] ?>"><span class="mode-icon"><i class="bi <?= $mode[2] ?>"></i></span><span class="mode-label"><?= $mode[0] ?></span><span class="mode-description"><?= $mode[1] ?></span><span class="mode-arrow" aria-hidden="true">→</span></a></div>
                <?php endforeach ?>
            </div>
        </div>
    </section>
    <section id="quy-trinh" class="section bg-light" data-process-section>
        <div class="container">
            <div class="text-center mb-5">
                <p class="eyebrow text-primary">Quy trình rõ ràng</p>
                <h2 class="fw-bold split-heading">Từ ý tưởng đến bàn giao trong 4 bước</h2>
            </div>
            <div class="row g-4"><?php foreach (['Tiếp nhận' => 'Lắng nghe mục tiêu và tư vấn giải pháp.', 'Thiết kế' => 'Xây dựng giao diện đúng thương hiệu.', 'Lập trình' => 'Phát triển nhanh, chuẩn kỹ thuật.', 'Bàn giao' => 'Hướng dẫn quản trị và đồng hành.'] as $i => $desc): ?><div class="col-md-3 process-step" data-process-step>
            ...
            <div class="row justify-content-between g-4">
                ...
                <div class="col-lg-6">
                    <form id="lead-form" action="api/submit_lead.php" method="post" class="bg-white text-dark p-4 rounded-4 shadow">
                        <?= csrf_field() ?><div class="d-none" aria-hidden="true"><label>Website<input name="website" tabindex="-1" autocomplete="off"></label></div>
                        <div class="row g-3">
